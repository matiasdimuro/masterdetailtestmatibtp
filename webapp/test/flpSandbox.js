		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Master Detail Test",
									"targetURL": "#hexagonmasterdetailtestmatibtp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"hexagonmasterdetailtestmatibtp-display": {
								"semanticObject": "hexagonmasterdetailtestmatibtp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=hexagon.masterdetailtestmatibtp",
									"url": sap.ui.require.toUrl("hexagon/masterdetailtestmatibtp")
								}
							}
						}
					}
